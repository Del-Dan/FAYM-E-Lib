"""
Django settings for elib_project project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-dev-key-placeholder')
...
ROOT_URLCONF = 'elib_project.urls'
...
WSGI_APPLICATION = 'elib_project.wsgi.application'
